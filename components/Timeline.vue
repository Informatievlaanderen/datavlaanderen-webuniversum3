    ...
    <div v-if="hasItems" class="wrapper-timeline">
      ...
      >
        <div class="section-year">
          <p v-if="hasYear(timelineContent) && !checkDateSameness(timelineIndex)" class="year">
            {{ getFormattedDate(timelineContent) }}
          </p>
        </div>
        <TimelineItem
