...
export async function parse_ontology_from_json_ld_file_voc (ld, hostname = "hostname") {
...
export async function parse_ontology_from_json_ld_file_ap (ld, hostname = "hostname", forceskos = false) {
  const expanded = await jsonld.expand(ld)
  // console.log(JSON.stringify(expanded));
...
export async function parse_ontology_from_json_ld_file_all (ld, hostname, forceskos = false) {
  const expanded = await jsonld.expand(ld)
  // console.log(JSON.stringify(expanded));
